                        ...
                        <div id="Footer-Row" className='flex flex-col items-center'>
                            ...
                            <div className='mt-[64px] flex items-center gap-[24px]'>
                                    <a href='#' className='bg-white flex items-center gap-[11px] py-[10px] px-[22px] w-fit rounded-[8px]'>
                                        ...
                                        <div>
                                            <p className='text-gray800 text-sm leading-[15px]'>Download on the</p>
                                            <h2 className='text-[20px] text-gray800 font-semibold leading-[26px]'>Apple Store</h2>
                                        </div>
                                    </a>
                                    <a href='#' className='bg-white flex items-center gap-[11px] py-[10px] px-[22px] w-fit rounded-[8px]'>
                                        <img src={Play} alt="icon" />
                                        <div>
                                            <p className='text-gray800 text-sm leading-[15px]'>GET IT ON</p>
                                            <h2 className='text-[20px] text-gray800 font-semibold leading-[26px]'>Google Play</h2>
                                        </div>
                                    </a>
                            </div>
                            {/* -------Footer Social Links------- */}
